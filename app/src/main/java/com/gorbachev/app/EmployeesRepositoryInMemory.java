...
public class EmployeesRepositoryInMemory  implements EmployeesRepository {
    ...
    private EmployeesRepositoryInMemory() {
        map.put(1L, new Employee(1l, "Dima", 28,5000));
        map.put(2L, new Employee(1l, "Misha", 27,400));
        map.put(3L, new Employee(1l, "Pasha", 26,300));
    ...
    private long generatedId() {
        long id;
        do {
            id = ThreadLocalRandom.current().nextLong(1,1_1000);
